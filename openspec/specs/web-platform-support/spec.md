# Capability: Web Platform Support

## Purpose
Enables running the application in a standard web browser environment. Provides Single Page Application (SPA) mode configuration, platform-guarded notifications, and graceful degradation for notifications on the web platform.
